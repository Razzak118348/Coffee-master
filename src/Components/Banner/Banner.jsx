...
<div className="w-full p-4 md:w-[60vw] space-y-2 text-white py-5 ">
    <h1 className="text-xl md:text-3xl font-bold">Would you like a Cap of Delicious Coffee</h1>
<p className="w-full md:w-3/4">It's coffee time - Sip & Savor - Relaxation in every sip! Get the nostalgia back!! Your companion of every moment!!! Enjoy the beautiful moments and make them memorable.</p>
